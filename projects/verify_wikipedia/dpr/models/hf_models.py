...
if transformers.__version__.startswith("4"):
    ...
    from transformers.modeling_outputs import BaseModelOutput, SequenceClassifierOutput, BaseModelOutputWithPoolingAndCrossAttentions
else:
...
def get_roberta_tensorizer(cfg):
    ...
    tokenizer = get_roberta_tokenizer(pretrained_model_cfg, do_lower_case=do_lower_case, additional_special_tokens=list(cfg.special_tokens))
...
def get_deberta_tensorizer(cfg):
    ...
    tokenizer = get_deberta_tokenizer(pretrained_model_cfg, do_lower_case=do_lower_case, additional_special_tokens=list(cfg.special_tokens))
...
def get_roberta_tokenizer(pretrained_cfg_name: str, do_lower_case: bool = True, additional_special_tokens=None):
    ...
    return RobertaTokenizer.from_pretrained(pretrained_cfg_name, do_lower_case=do_lower_case, additional_special_tokens=additional_special_tokens)
...
def get_deberta_tokenizer(pretrained_cfg_name: str, do_lower_case: bool = True, additional_special_tokens=None):
    ...
    return DebertaV2Tokenizer.from_pretrained(pretrained_cfg_name, do_lower_case=do_lower_case, additional_special_tokens=additional_special_tokens)
